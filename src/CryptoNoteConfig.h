...
namespace CryptoNote
{
	namespace parameters
	{
		...
		const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0xefe5c5b; /* dkash address prefix */
		...
		const uint64_t MONEY_SUPPLY = UINT64_C(302311935000000); /* max supply: 302M (Consensus II) */
		 const uint64_t GENESIS_BLOCK_REWARD = UINT64_C(30231193500000);
		...
		const uint64_t MINIMUM_FEE = UINT64_C(10);			  /* 0.000010 dkash */
		const uint64_t MINIMUM_FEE_V1 = UINT64_C(100);		  /* 0.000100 dkash */
		const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000);		  /* 0.001000 dkash */
		const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000);  /* 0.001000 dkash */
		const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 dkash */
	...
	const char CRYPTONOTE_NAME[] = "draftkash";
	...
	const int P2P_DEFAULT_PORT = 30231;
	const int RPC_DEFAULT_PORT = 30239;
	...
	const static boost::uuids::uuid CRYPTONOTE_NETWORK = { { 0x30, 0x9c, 0x11, 0x3e, 0x23, 0x12, 0x5f, 0x8e, 0x2e, 0x3e, 0x31, 0x30, 0x35, 0x3f, 0x22, 0x3b } };

	// Seed Nodes
	const std::initializer_list<const char *> SEED_NODES = {
		"52.53.217.127:30231" // 
		"54.165.33.33:30231" // 
		"18.134.164.233:30231 //
		"35.182.71.143:30231 //
	};
