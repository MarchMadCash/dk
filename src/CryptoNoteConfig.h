...
namespace CryptoNote
{
	namespace parameters
	{
		...
		const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0xf98e412ec; /* gamefi address prefix */
		...
		const uint64_t MINIMUM_FEE = UINT64_C(10);			  /* 0.000010 gamefi */
		const uint64_t MINIMUM_FEE_V1 = UINT64_C(100);		  /* 0.000100 gamefi */
		const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000);		  /* 0.001000 gamefi */
		const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000);  /* 0.001000 gamefi */
		const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.000010 gamefi */
	...
	const uint64_t REWARD_INCREASE_INTERVAL = (UINT64_C(21900));			   // aprox. 1 month (+ 0.25 gamefi increment per month)

	const char CRYPTONOTE_NAME[] = "gamefi";
